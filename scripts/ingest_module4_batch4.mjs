...
const newQuestionsPath = path.join(process.cwd(), 'src/lib/domain4_batch4.json');
...
console.log(`Successfully ingested ${newQuestions.length} questions from Module 4 Batch 4.`);
