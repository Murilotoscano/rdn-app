...
const newQuestionsPath = path.join(process.cwd(), 'src/lib/domain4_batch1.json');
...
console.log(`Successfully ingested ${newQuestions.length} questions from Module 4 Batch 1.`);
