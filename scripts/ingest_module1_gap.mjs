...
const newQuestionsPath = path.join(process.cwd(), 'src/lib/domain1_batch_gap_fill.json');
...
console.log(`Successfully ingested ${newQuestions.length} questions from Module 1 Gap Fill Batch.`);
