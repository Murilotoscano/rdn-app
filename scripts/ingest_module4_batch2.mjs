...
const newQuestionsPath = path.join(process.cwd(), 'src/lib/domain4_batch2.json');
...
console.log(`Successfully ingested ${newQuestions.length} questions from Module 4 Batch 2.`);
